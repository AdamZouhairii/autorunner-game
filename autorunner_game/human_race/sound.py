...
class SoundManager:
    def __init__(self):
        pygame.mixer.init()
        self.menu_music = os.path.join("autorunner_game","human_race","sounds", "menusic.mp3")
        self.game_music = os.path.join("autorunner_game","human_race","sounds", "game_music.mp3")
        self.game_over_music = os.path.join("autorunner_game","human_race","sounds", "game_over1.mp3")
        self.yellow_coin_sound = os.path.join("autorunner_game","human_race","sounds", "yellow_coin.mp3")
        self.blue_coin_sound = os.path.join("autorunner_game","human_race","sounds", "blue_coin.mp3")
        self.blue_obstacle_break_sound = os.path.join("autorunner_game","human_race","sounds", "blue_obstacle_break.mp3")
        self.game_over_sound = os.path.join("autorunner_game","human_race","sounds", "game_over3.mp3")
