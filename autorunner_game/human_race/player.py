...
class Player(pygame.sprite.Sprite):
    image = pygame.image.load(r'autorunner_game\data\zoro.png').convert_alpha()
    ...
    def updat(self, dt):
        ...
        print("Sprite mis à jour : x =", self.x, ", y =", self.y, ", vx =", self.vx, ", vy =", self.vy)
...
class Background:
    ...
    def resize(self, screen_width, screen_height):
        self.image = pygame.transform.scale(self.image_original, (screen_width, screen_height))
