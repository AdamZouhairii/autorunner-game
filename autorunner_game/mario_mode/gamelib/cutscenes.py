...
def cutscene(screen, text):
    """
    Display a cutscene on the screen with the given text.

    Args:
        screen (pygame.Surface): The surface to display the cutscene on.
        text (list): A list of strings representing the lines of text to display.
